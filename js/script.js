...
for (let i = 0; i < pokemonList.length; i++) { //Command will write list no matter how many items are added.
  if (pokemonList[i].height < 0.4) { // Code to be used with smaller pokemons
    ...
    document.write("<p>" + pokemonList[i].name + "<br>", pokemonList[i].height + ' Look! A tiny pokemon.' +
    "<br>", pokemonList[i].type + "<br>", "</p>");
      ...
      document.write(pokemonList[i].name + "<br>", "</p>");
      ...
      document.write(pokemonList[i].name + "<br>", pokemonList[i].height + "<br>", pokemonList[i].type + "<br>", "</p>");
    }
}
